...
public class DatabaseInitials {
    ...
    public CommandLineRunner commandLineRunner(ApplicationContext ctx) {
        ...
        return args -> {
            ...
            Topic t1 = new Topic("Topic 1", "Summary 1 Summary 1 Summary 1 ", "Zinedine Zidane", Calendar.getInstance().getTime(), 5, conf);
            Topic t2 = new Topic("Topic 2", "Summary 2 Summary 2 Summary 2 ", "Valentino", Calendar.getInstance().getTime(), 7,conf);
            Topic t3 = new Topic("Topic 3", "Summary 3 Summary 3 Summary 3 ", "Valentino", Calendar.getInstance().getTime(), 4, conf);
            Topic t4 = new Topic("Topic 4", "Summary 4 Summary 4 Summary 4 ", "Wanda Wunderbar Waldermot", Calendar.getInstance().getTime(), 2,conf);
            Topic t5 = new Topic("Topic 5", "Summary 5 Summary 5 Summary 5 ", "Xavier X-Man", Calendar.getInstance().getTime(), 10, conf);
